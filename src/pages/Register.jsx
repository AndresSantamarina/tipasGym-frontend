        ...
        <div className="min-h-screen bg-[#fbf4e4] flex items-center justify-center p-4">
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#223c1f]">Nuevo Administrador</h1>
                </div>

                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div>
                        <label className="block text-[#223c1f] font-semibold mb-2">Usuario</label>
                        <input 
                    ...
                    <div>
                        <label className="block text-[#223c1f] font-semibold mb-2">Contraseña</label>
                        <input 
                            type="password"
                ...
                <div className="mt-6 text-center">
                    <Link to="/login" className="text-[#659d3a] font-bold hover:underline text-sm">
